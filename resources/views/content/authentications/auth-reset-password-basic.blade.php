    ...
    <div class="authentication-inner py-6">
      <div class="card">
        <div class="card-body">
          ...
          <p class="mb-6">A nova senha deve ser diferente das anteriores.</p>
          ...
          <form id="formAuthentication" action="{{ route('password.update') }}" method="POST">
            ...
            <div class="mb-6 form-control-validation">
              ...
              <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email', $email ?? '') }}" placeholder="seu@email.com" />
            ...
            <button class="btn btn-primary d-grid w-100 mb-6">Salvar nova senha</button>
