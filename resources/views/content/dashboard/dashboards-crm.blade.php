        ...
        <ul class="nav nav-tabs widget-nav-tabs pb-8 gap-4 mx-1 d-flex flex-nowrap" role="tablist">
          ...
          <li class="nav-item">
            <a href="javascript:void(0);"
              ...
              aria-selected="false">
              <div class="badge bg-label-secondary rounded p-2"><i class="icon-base ti tabler-chart-pie-2 icon-md"></i>
              </div>
    ...
    <div class="card h-100">
      ...
      <div class="card-body">
        <ul class="p-0 m-0">
          ...
          <li class="mb-4 d-flex">
            <div class="d-flex w-50 align-items-center me-4">
              <img src="{{ asset('assets/img/icons/brands/bootstrap-logo.png') }}" alt="bootstrap-logo" class="me-4"
                width="35" />
              <div>
