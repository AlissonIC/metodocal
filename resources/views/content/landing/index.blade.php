...
<nav class="lp-nav">
  <div class="container py-3 d-flex align-items-center justify-content-between">
    <a href="{{ route('home') }}" class="lp-logo text-decoration-none">{{ config('variables.templateName', 'MetodoCal') }}</a>
...
<footer class="lp-footer">
  <div class="container">
    <div class="row g-4 mb-4">
      <div class="col-md-4">
        <div class="lp-logo mb-3">{{ config('variables.templateName', 'MetodoCal') }}</div>
  ...
  <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <h6>10. Foro</h6>
        <p>Fica eleito o foro da comarca da sede do {{ config('variables.templateName', 'MetodoCal') }} para dirimir quaisquer questões oriundas destes Termos, com renúncia a qualquer outro, por mais privilegiado que seja.</p>
      </div>
  ...
  <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>O controlador dos dados pessoais é o {{ config('variables.templateName', 'MetodoCal') }}, com canal de contato pelo e-mail de suporte indicado em <a href="{{ config('variables.creatorUrl', '#') }}">{{ config('variables.creatorUrl', 'metodocal.com.br') }}</a>.</p>
        ...
        <p>Para questões específicas sobre privacidade e proteção de dados, o usuário pode contatar o Encarregado pelo e-mail indicado no painel da conta.</p>
